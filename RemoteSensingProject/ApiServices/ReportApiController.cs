...
using static RemoteSensingProject.Models.DocxGenerator;

[JwtAuthorize(Roles = "admin,projectManager,accounts,prashasan")]
public class ReportApiController : ApiController
{
    ...
    [HttpGet]
    [Route("api/report/manpowerMonthlyreportpdf")]
    public IHttpActionResult ManpowerMonthlyReportPdf(int id, int month, int year)
    {
        List<DivisionOutsourceReport> data = _managerservice.GetManpowerMonthlyReport(id, year, month);
        string monthName = CultureInfo.CurrentCulture
        .DateTimeFormat
        .GetMonthName(month);
        byte[] pdfBytes = DocxGenerator.CreateManpowerMonthlyDocx(data, monthName, year);
    ...
    public static List<MonthlyProgressRow> GetDummyData()
    {
        ...
        {
            new MonthlyProgressRow
            {
                SchemeName = "रिमोट सेंसिंग आधारित भूमि उपयोग परियोजना",
                AnnualFinancial = 50,
                AnnualPhysical = 100,
                MonthlyTarget = 8,
                MonthlyProgress = 6,
                ...
                ProgressPercent = 45,
                StateShare = 30,
                BeneficiaryShare = 120
            },
            new MonthlyProgressRow
            {
                SchemeName = "जल संसाधन मैपिंग योजना",
                AnnualFinancial = 40,
                AnnualPhysical = 80,
                MonthlyTarget = 7,
                MonthlyProgress = 5,
                CumulativeProgress = 38,
                ProgressPercent = 47.5m,
                StateShare = 28,
                BeneficiaryShare = 95
            },
            new MonthlyProgressRow
            {
                SchemeName = "शहरी विकास जीआईएस परियोजना",
                AnnualFinancial = 60,
                AnnualPhysical = 120,
                MonthlyTarget = 10,
                MonthlyProgress = 9,
                CumulativeProgress = 70,
                ProgressPercent = 58.33m,
                StateShare = 45,
                BeneficiaryShare = 210
            }
        };
    }
    #endregion
